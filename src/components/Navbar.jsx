        ...
        <div className="px-8 md:px-14 lg:px-28">
          ...
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4">
            ...
            <div className={style} id="navbar-sticky">
              <ul className="flex flex-col p-4 lg:p-0 mt-4 font-medium border border-gray-300 rounded-lg bg-gray-50 lg:space-x-6 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0 lg:bg-background lg:dark:bg-gray-300 lg:items-center lg:dark:hover:black">
                ...
                <a
                  ...
                  target="_blank"
                  aria-label="Discord invite"
                  className="border-t border-gray-200 md:border-none dark:border-gray-800 mt-4 md:mt-0 mt:border-none "
                >
                  <button
                    type="button"
